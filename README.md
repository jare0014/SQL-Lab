...
I implemented case-insensitive checks (.lower() and .upper()) throughout the lab. Experience has shown that metadata is rarely consistent. For example, Time_Stamp is just as likely as timestamp. My code assumes the data is messy and builds the filter accordingly.
